      ...
      <form name="invoice-form" className="invoice-form">
        ...
        <div className="h-flex align-center space-between" style={{ flexWrap: 'wrap' }}>
          ...
          <div>
            ...
            <select style={{ padding: '.5rem' }} defaultValue="Select Client" onChange={fillClientInfoOfClient}>
        ...
        <div style={{
          ...
          />
          {
            (!nameOfProject && showErrors) && <label style={{ marginLeft: '1rem' }} className={'error'} htmlFor="name-of-project">Please add project title</label>
          }
        ...
        <div className="v-flex center" style={{ width: '100%' }}>
          {readyToUpload ? (
          ...
          <p style={{ margin: 0, textAlign: 'center' }}> This invoice # is: {linvoiceNumber + 1} </p>
        </div>
      </form>
    </div >
  );
